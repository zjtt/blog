...
::: tip 提示
有阅读障碍的同学，可以跳过第一至四节，下载我写好的[工具包](https://github.com/zjttcc/vuepress-devkit.git): 
`git clone https://github.com/zjttcc/vuepress-devkit.git` 然后从第五节开始看。
:::
...
例如我的 Github 账号名称是 zjttcc

![](/images/eg13.png)

那么新建仓库，Repository name 就填写为：zjttcc.github.io
...
- 使用工具包的，将 [vuepress-devkit](https://github.com/zjttcc/vuepress-devkit.git) 中的内容拷贝到 vuepressBlog 文件夹中
...
把文件中的 USERNAME 改成 Github 账号名，例如我的账号名是 zjttcc，那么就可以改为：

```sh
# 如果你想要部署到 https://USERNAME.github.io
git push -f git@github.com:zjttcc/zjttcc.github.io.git master
```
...
此时打开 Github Settings 中下面的链接: [https://zjttcc.github.io/](https://zjttcc.github.io/) 即可看到自己的主页啦~
...
## 六、发布到自己的个人域名
如果你不满足于 https://zjttcc.github.io/ 这样的域名，想要一个自己个人的专属域名，比如 http://www.zjtt.cc/ ，毕竟一些大牛（阮一峰 [http://www.ruanyifeng.com/blog/](http://www.ruanyifeng.com/blog/)） 都是自己名字的网址哦，很方便很酷呢 😎 
...
### :clap: 大功告成，打开 [https://www.zjtt.cc](https://www.zjtt.cc) 看一下吧~~~
...
我的 [vuepress-devkit](https://github.com/zjttcc/vuepress-devkit.git) 已经开源放在了 Github 上，还有很多想要增加的功能，例如添加评论模块、自动生成侧边栏目录、增加网站分析工具等等，在这里欢迎大家 Star 或者 Fork 。
